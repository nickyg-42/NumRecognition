...
def calculate_canvas_pixel_value(canvas):
    ...
    pixel_value = np.sum(np.array(img.convert("L"))) / (
...
clear_button = ttk.Button(
    root, text="Clear Canvas", command=clear_canvas, takefocus=False
)
...
output_digit_label = tk.Label(
    root,
    textvariable=output_digit,
    font=("", 15),
    bg="white",
    fg="black",
    width=5,
